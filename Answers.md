# Affordable House Productions: My Notes & Answers
...
* A total of Very Low Income **5826 units**. 
* The sum of All Count Units **27755**.
* The percentage of people being affected is about **41%**. It's somewhat close to half the people, so there is major room for improvement.
...
* **6.8% (7% rounded)** of all units in the *Bronx* are family-sized (3 bedrooms or more).
* **10%** of all units in *Manhattan* are family-sized (3 bedrooms or more)
* **4%** of all units in *Queens* are family-sized (3 bedrooms or more)
* **11%** of all units in *Brooklyn* are family-sized (3 bedrooms or more)
* There is no percent/ratio of family units to all counted units for the borough of Staten Island.
* **So in 2023, the borough of Brooklyn provided the most family units in NYC. And Staten Island and/or Queens provided the fewest family units in NYC.**
...
**Question 5**: The "New vs. Old" Ratio: How does the total volume of New Construction (adding new supply) compare to Preservation (maintaining existing supply) across the city?
Answers: 
...
**Question7**: The Neighborhood Hotspots: List the top 5 Neighborhood Tabulation Areas (NTAs) that saw the highest concentration of units, and are they clustered in specific areas?
Answers:
